    ...
    <div className="space-y-6">
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Get help with Learning Platform features - Ask me anything!</p>
        </div>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2">
          <Card className="h-[70vh] min-h-[500px] max-h-[800px] flex flex-col overflow-hidden">
            <CardHeader className="pb-3 flex-shrink-0">
              <div className="flex items-center space-x-2">
                <MessageSquare className="h-5 w-5 text-blue-600" />
                <CardTitle className="text-lg">Chat Assistant</CardTitle>
                <Badge variant="secondary">{userRole.charAt(0).toUpperCase() + userRole.slice(1)} Mode</Badge>
              </div>
              <CardDescription>Ask questions about any platform feature and get instant help</CardDescription>
            </CardHeader>
                  ...
                  <div className="space-y-4 pb-4">
                      ...
                      >
                        ...
                        >
                          <div className="flex items-start space-x-3">
                            ...
                            <div className="text-sm whitespace-pre-wrap leading-relaxed break-words overflow-wrap-anywhere min-w-0 flex-1">
                              {message.text}
                            </div>
                          </div>
                    ...
                    {isTyping && (
                      <div className="flex justify-start w-full">
                        <div className="bg-gray-100 rounded-lg px-4 py-3 max-w-[75%] overflow-hidden">
                          <div className="flex items-center space-x-3">
              ...
              {userRole === "student" && (
                <>
                  <div className="text-sm">
                    ...
                    <div className="text-muted-foreground">Join classes, view dashboard</div>
                  </div>
                  <div className="text-sm">
                    <div className="font-medium">Assignments</div>
                    <div className="text-muted-foreground">Submit work, check grades</div>
                  </div>
                  <div className="text-sm">
                    <div className="font-medium">Performance</div>
                    <div className="text-muted-foreground">Attendance, rankings</div>
                  </div>
                </>
              )}
              ...
              {userRole === "lecturer" && (
                <>
                  <div className="text-sm">
                    ...
                    <div className="text-muted-foreground">Create, manage classes</div>
                  </div>
                  <div className="text-sm">
                    <div className="font-medium">Assignments</div>
                    <div className="text-muted-foreground">Create, grade assignments</div>
                  </div>
                  <div className="text-sm">
                    <div className="font-medium">Student Tracking</div>
                    <div className="text-muted-foreground">Attendance, performance</div>
                  </div>
                </>
              )}
              ...
              {userRole === "admin" && (
                <>
                  <div className="text-sm">
                    ...
                    <div className="text-muted-foreground">Manage all users</div>
                  </div>
                  <div className="text-sm">
                    <div className="font-medium">System Overview</div>
                    <div className="text-muted-foreground">Classes, statistics</div>
                  </div>
                  <div className="text-sm">
                    <div className="font-medium">Administration</div>
                    <div className="text-muted-foreground">Platform management</div>
                  </div>
                </>
              )}
            </CardContent>
